...
const Dashboard = () => {
  ...
  const todayTasks = [
    ...getSorted(tasksActiveToday),
    ...getSorted(challengeActiveTasks),
  ];
      ...
      <Container>
        <section className="today-section">
          ...
          <CardList
            isVisible={true}
            tasks={todayTasks}
            onCloseModal={() => setIsCreateFormShow(false)}
        ...
        <section className="done-section">
          <div className="wrapper-done">
            <Button
              className={doneIsShown ? "active" : ""}
              onClick={() => setDoneIsShown(!doneIsShown)}
            >
              Done
            </Button>
          </div>
